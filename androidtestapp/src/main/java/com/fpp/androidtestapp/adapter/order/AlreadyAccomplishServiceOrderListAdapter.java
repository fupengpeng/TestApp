...
/**
 * @description  已完成服务单列表Adapter
 * @author  fupengpeng
 * @date  2017/12/20 0020 19:52
 */

public class AlreadyAccomplishServiceOrderListAdapter extends BaseAdapter<OrderItem> {
     ...
     * @param data
     */
    public AlreadyAccomplishServiceOrderListAdapter(Context context, List<OrderItem> data) {
        super(context, data);
    }
