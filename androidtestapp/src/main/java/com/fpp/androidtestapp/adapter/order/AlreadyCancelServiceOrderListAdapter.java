...
/**
 * @description  已取消服务单列表Adapter
 * @author  fupengpeng
 * @date  2017/12/20 0020 19:57
 */

public class AlreadyCancelServiceOrderListAdapter extends BaseAdapter<OrderItem> {
     ...
     * @param data
     */
    public AlreadyCancelServiceOrderListAdapter(Context context, List<OrderItem> data) {
        super(context, data);
    }
