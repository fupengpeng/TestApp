...
/**
 * @description  取消服务单列表Adapter
 * @author  fupengpeng
 * @date  2017/12/21 0021 8:58
 */

public class ServiceOrderListAdapter extends BaseAdapter<OrderItem> {
     ...
     * @param data
     */
    public ServiceOrderListAdapter(Context context, List<OrderItem> data) {
        super(context, data);
    }
