...
/**
 * @description  进行中服务单列表Adapter
 * @author  fupengpeng
 * @date  2017/12/20 0020 19:56
 */

public class UnderwayServiceOrderListAdapter extends BaseAdapter<OrderItem> {
     ...
     * @param data
     */
    public UnderwayServiceOrderListAdapter(Context context, List<OrderItem> data) {
        super(context, data);
    }
