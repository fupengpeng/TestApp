...
public class WeiBoActivity extends Activity {
    ...
    /**
     * 2初始化动画，这个就是页卡滑动时，下面的横线也滑动的效果，在这里需要计算一些数据
     *
     * */

    private void InitImageView() {
        Log.e(TAG, "InitImageView: "+"初始化动画");
        imageView= (ImageView) findViewById(R.id.cursor);

        bmpW = BitmapFactory.decodeResource(getResources(), R.drawable.android).getWidth();// 获取图片宽度
    ...
    private class MyOnClickListener implements OnClickListener{
        ...
        public MyOnClickListener(int i){
            Log.e(TAG, "MyOnClickListener: "+"图标点击监听" );
            index=i;
        }
        public void onClick(View v) {
            Log.e(TAG, "onClick: "+"图标点击事件" );
    ...
    public class MyOnPageChangeListener implements OnPageChangeListener{
        ...
        public void onPageSelected(int arg0) {
            ...
            */
            ...
            Log.e(TAG, "onPageSelected: "+"展示"+arg0+"个页面" );
